...
class Me(models.Model):
	...
	image = models.ImageField(width_field=img_width, height_field=img_height, blank=True)
	tmb_image = models.ImageField(width_field=tmb_width, height_field=tmb_height, blank=True)
...
class SocialAccounts(models.Model):
	...
	user = models.ForeignKey(Me, on_delete=models.CASCADE, blank=True, null=True, related_name='social_accounts')
...
class Work(models.Model):
	...
	user = models.ForeignKey(Me, on_delete=models.CASCADE, blank=True, null=True, related_name='work')
...
class Education(models.Model):
	...
	doc2 = models.FileField(blank=True)
	doc3 = models.FileField(blank=True)
	user = models.ForeignKey(Me, on_delete=models.CASCADE, blank=True, null=True, related_name='education')
...
class Skills(models.Model):
	...
	doc2 = models.FileField(blank=True)
	doc3 = models.FileField(blank=True)
	user = models.ForeignKey(Me, on_delete=models.CASCADE, blank=True, null=True, related_name='skills')
...
class Projects(models.Model):
	...
	image = models.ImageField(width_field=img_width, height_field=img_height, blank=True)
	tmb_image = models.ImageField(width_field=tmb_width, height_field=tmb_height, blank=True)
	user = models.ForeignKey(Me, on_delete=models.CASCADE, blank=True, null=True, related_name='projects')
